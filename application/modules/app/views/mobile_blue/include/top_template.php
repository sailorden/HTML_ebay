<?php if ($html->img_top_1_html): ?>
	...
	<div class="col-md-4 header-top top_1">
		<input style="display: none;" name="img_top_1_html" id="img_top_1_html" type="file" class="jfilestyle top image"/>
...
<?php if ($html->img_top_2_html): ?>
	...
	<div class="col-md-4 header-top top_2">
		<input style="display: none;" name="img_top_2_html" id="img_top_2_html" type="file" class="jfilestyle top image"/>
...
<?php if ($html->img_top_3_html): ?>
	...
	<div class="col-md-4 header-top top_3">
		<input style="display: none;" name="img_top_3_html" id="img_top_3_html" type="file" class="jfilestyle top image"/>
...
<input id="folder_image" type="hidden" value="top"/>
