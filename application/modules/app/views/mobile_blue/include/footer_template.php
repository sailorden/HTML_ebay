<?php if ($html -> title_footer_1): ?>
	...
	<div class="footer-grid">
		...
		<button id="text_footer_1" class="buttons_interface textarea"><i class="fa fa-pencil"></i></button>
	</div>
...
<?php if ($html -> title_footer_2): ?>
	...
	<div class="footer-grid">
		...
		<button id="text_footer_2" class="buttons_interface textarea"><i class="fa fa-pencil"></i></button>
	</div>
